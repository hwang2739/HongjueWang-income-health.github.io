...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Diabetes & Income, by region"), out.width="100%", out.height="100%"}
knitr::include_graphics("Images/diabetesplotanim.gif")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Diabetes rate by county: 2016")}
knitr::include_graphics("Images/diabetes_counties_2016_map.png")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Diabetes adjusted metric by county: 2016")}
knitr::include_graphics("Images/diabetes_income_ratio_counties_2016_map.png")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Life Expectancy & Income, by region"), out.width="100%", out.height="100%"}
knitr::include_graphics("Images/lifeplotanim.gif")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Life expectancy by county: 2014")}
knitr::include_graphics("Images/life_expectancy_counties_2014_map.png")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Life expectancy adjusted metric by county: 2014")}
knitr::include_graphics("Images/life_expectancy_adjusted_counties_2014_map.png")
```
...
```{r, message = FALSE, warning = FALSE, fig.cap = paste("Infant mortality & Income, by region")}
knitr::include_graphics("Images/infantplotanim.gif")
```
...
popup = paste("State: ", dt_year$state,
              "<br>Income per capita: ", dt_year$income_per_capita,
              "<br>Uninsured rate: ", dt_year$uninsured)

states.merged <- merge(x=states, y=dt_year, by.x=c("NAME"), by.y=c("state"), duplicateGeoms = TRUE)
